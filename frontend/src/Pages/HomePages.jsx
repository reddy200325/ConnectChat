...
const HomePages = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-[#0A0F1D] overflow-hidden">
      ...
      {/* MAIN LAYOUT */}
      {selectedUser ? (
        <div className="relative h-screen hidden md:grid grid-cols-[29%_1%_40%_1%_29%]">
          {/* LEFT SIDEBAR */}
          ...
          {/* CHAT */}
          <div className="h-full overflow-hidden">
            <ChatProcess setShowRightSidebar={setShowRightSidebar} />
          </div>
          <div />
        ...
        <div className="relative h-screen grid grid-cols-1 md:grid-cols-[29%_1%_70%]">
          {/* LEFT SIDEBAR */}
          <div className="h-full overflow-hidden">
            <SideBar />
          </div>
